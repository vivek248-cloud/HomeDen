...
const wrapper = document.querySelector(".image-wrapper");
  ...
  document.querySelector(".contact-image").addEventListener("mousemove", (e) => {
  ...
  document.querySelector(".contact-image").addEventListener("mouseleave", () => {
    wrapper.style.transform = `rotateX(0deg) rotateY(0deg)`;
  });


    const contactImage = document.querySelector('.contact-image');
  const dot = contactImage.querySelector('.cursor-dot');
  const ring = contactImage.querySelector('.cursor-ring');

  contactImage.addEventListener('mousemove', (e) => {
  ...
  // Hide/show cursor on enter/leave
